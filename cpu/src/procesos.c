...
void _aplicar_sum_a_registro(char **comandos, void *regist)
{
    ...
    if (strcmp(comandos[2], "AX") == 0)
        ...
        SUM(regist, &BX_registro);
    else if (strcmp(comandos[2], "CX") == 0)
        SUM(regist, &CX_registro);
    else if (strcmp(comandos[2], "DX") == 0)
        SUM(regist, &DX_registro);
    else if (strcmp(comandos[2], "EAX") == 0)
        SUM(regist, &EAX_registro);
    else if (strcmp(comandos[2], "EBX") == 0)
        SUM(regist, &EBX_registro);
    else if (strcmp(comandos[2], "ECX") == 0)
        SUM(regist, &ECX_registro);
    else if (strcmp(comandos[2], "EDX") == 0)
        SUM(regist, &EDX_registro);
    else if (strcmp(comandos[2], "SI") == 0)
        SUM(regist, &SI_registro);
    else if (strcmp(comandos[2], "DI") == 0)
        SUM(regist, &DI_registro);
    else if (strcmp(comandos[2], "PC") == 0)
        SUM(regist, &DI_registro);
}
void _aplicar_sub_a_registro(char **comandos, void *regist)
{
    ...
    if (strcmp(comandos[2], "AX") == 0)
        ...
        SUB(regist, &BX_registro);
    else if (strcmp(comandos[2], "CX") == 0)
        SUB(regist, &CX_registro);
    else if (strcmp(comandos[2], "DX") == 0)
        SUB(regist, &DX_registro);
    else if (strcmp(comandos[2], "EAX") == 0)
        SUB(regist, &EAX_registro);
    else if (strcmp(comandos[2], "EBX") == 0)
        SUB(regist, &EBX_registro);
    else if (strcmp(comandos[2], "ECX") == 0)
        SUB(regist, &ECX_registro);
    else if (strcmp(comandos[2], "EDX") == 0)
        SUB(regist, &EDX_registro);
    else if (strcmp(comandos[2], "SI") == 0)
        SUB(regist, &SI_registro);
    else if (strcmp(comandos[2], "DI") == 0)
        SUB(regist, &DI_registro);
    else if (strcmp(comandos[2], "PC") == 0)
        SUB(regist, &DI_registro);
}
