...
int main() {
    ...
    log_debug (kernel_log_debug, "Recursos: %s|%s|%s",config_valores.instancias_recursos  [0], config_valores.instancias_recursos  [1], config_valores.instancias_recursos  [2]);
